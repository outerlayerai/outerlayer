-- =============================================================================
-- Drops the eval/benchmark data plane: the `eval_run` and `env_escalation`
-- tables and the six `app_permission` enum values that gated them.
--
...
-- drop the old type. 87 RLS policies and 9 functions bind the type by OID, so
-- their definitions are captured BEFORE the rename (while `public.app_permission`
