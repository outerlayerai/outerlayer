-- Wires management_api_key into the two schema-wide conventions its own creation
-- migration (20260812174724_management_api_key.sql) left unapplied:
--
...
--    That rule only binds tables created after it ran; management_api_key's own
--    `GRANT ALL ON public.management_api_key TO authenticated` re-added the three
